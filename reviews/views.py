...
from reviews.serializers import ReviewSerializer,UpdateReviewSerializer,ReviewCreateSerializer
...
def get_list_of_reviews(request,id):
...
def create_review(request,id):
        ...
        reviewSerializer=ReviewCreateSerializer(data=request.data)
        if reviewSerializer.is_valid():
            reviewSerializer.save(company=company, reviewer=employee)
